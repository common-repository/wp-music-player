...
{
	var frm_obj = document.songs_list;
		if(check_chebox_checked(frm_obj["delId[]"]))
		{
			var result = confirm("Are you sure! you want to delete Songs");
			if(result==true)
			{
				frm_obj.action="options-general.php?page=music_player&action=deleteAll";
				frm_obj.submit();
